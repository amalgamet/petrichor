...
describe("toDailyChartData", () => {
  it("pairs daytime and nighttime periods into day records", () => {
    const periods = [
      makePeriod({ name: "Monday", isDaytime: true, temperature: 75, startTime: "2026-02-23T06:00:00-06:00" }),
      makePeriod({ name: "Monday Night", isDaytime: false, temperature: 55 }),
      makePeriod({ name: "Tuesday", isDaytime: true, temperature: 70, startTime: "2026-02-24T06:00:00-06:00" }),
  ...
  it("handles case where first period is nighttime (skips it)", () => {
    const periods = [
      ...
      makePeriod({ name: "Monday", isDaytime: true, temperature: 72, startTime: "2026-02-23T06:00:00-06:00" }),
      makePeriod({ name: "Monday Night", isDaytime: false, temperature: 55 }),
    ];
  ...
  it("handles missing night period (sets low to null)", () => {
    const periods = [
      makePeriod({ name: "Saturday", isDaytime: true, temperature: 80, startTime: "2026-02-28T06:00:00-06:00" }),
    ];
